...
<head>
    ...
    <!-- Normalize Css -->
    <link rel="stylesheet" href="{{asset('assets/css/normalize.css?v=1.0.0')}}">
    <!-- Main Css -->
    ...
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/animate.min.css?v=1.0.0')}}">
    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/fontawesome-all.min.css?v=1.0.0')}}">
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{asset('assets/fonts/flaticon.css?v=1.0.0')}}">
    <!-- Summernote CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/summernote.css?v=1.0.0')}}">
    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/owl.carousel.min.css?v=1.0.0')}}">
    <link rel="stylesheet" href="{{asset('assets/css/owl.theme.default.min.css?v=1.0.0')}}">
    <!-- Select 2 CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/select2.min.css?v=1.0.0')}}">
    <!-- Custom Css -->
    <link rel="stylesheet" href="{{asset('assets/style.css?v=1.0.0')}}">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-3 col-sm-4 col-4 possition-static">
                        ...
                        <nav class="site-nav">
                            <ul id="site-menu" class="site-menu">
                                ...
                                <li>
                                    <a href="{{route('author.recipe.index')}}">Recipes</a>
                                </li>
                                <li>
                                    <a href="#">Comments</a>
                                </li>
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-8 col-8 d-flex align-items-center justify-content-end">
                        <div class="nav-action-elements-layout1">
                            <ul>
                                <li>
                                    <a  class="fill-btn" href="{{route('frontend.home')}}">Homepage</a>
                                </li>
                            </ul>
                        </div>
