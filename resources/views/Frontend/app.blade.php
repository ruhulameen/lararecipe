                            ...
                            <ul id="site-menu" class="site-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu-col-1">
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.category.recipes',$category->slug) }}">{{ $category->name }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-8 col-8 d-flex align-items-center justify-content-end">
                        <div class="nav-action-elements-layout1">
                            <ul>
                                @auth
                                    <li>
                                        <a href="{{ Auth::user()->role->id == 1 ? route('admin.dashboard') : route('author.dashboard')}}" class="fill-btn"><i class="fas fa-tachometer"></i>Dashboard</a>
                                    </li>
                                @else
                                <li>
